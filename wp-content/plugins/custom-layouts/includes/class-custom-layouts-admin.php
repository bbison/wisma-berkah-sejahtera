	...
	public function enqueue_scripts() {
		...
		if ( $this->is_custom_layouts_settings() ) {
			...
			if ( Util::screen_is_layout_edit() ) {
				...
				wp_enqueue_script( $this->plugin_name . '-layout', plugin_dir_url( dirname( __FILE__ ) ) . 'assets/js/admin/layout/custom-layouts' . $file_ext, array( 'wp-element', 'wp-components', 'wp-date', 'wp-compose', 'wp-data', 'wp-editor', 'wp-api-fetch' ), $this->version, true );
				...
				wp_enqueue_script( $this->plugin_name . "-template", plugin_dir_url( dirname( __FILE__ ) ) . 'assets/js/admin/template/custom-layouts' . $file_ext, array( 'wp-element', 'wp-components', 'wp-date', 'wp-compose', 'wp-data', 'wp-editor', 'wp-api-fetch' ), $this->version, true );
